...
import { AuthHook, loginHook } from "../../hooks/auth/Auth.hook";

const SignInPage = () => {
  // const { errorMessage, handleChangeInput,passwordShow,setPasswordShow,handleSignUp ,signData,navigation} = AuthHook()
  const { handleSubmitLogin,handleOnChangesInputLogin,loginData,errorMessage,passwordShow ,setPasswordShow,navigation} = loginHook()
  return (
    <>
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg sm:p-10">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) => handleOnChangesInputLogin(e)}
              />
              {errorMessage && (
            ...
            <button onClick={()=> navigation('/forget')} className="underline top-20] relative bottom-3 left-[50%] text-red-400 md:bottom-3 md:left-[65%]">
              forget password ?
            </button>
